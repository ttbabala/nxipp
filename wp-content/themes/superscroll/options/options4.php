...
<b class="bt">多语言翻译</b><br />
           ...
           <input type="text" size="20"  name="language1" id="language1" value="<?php echo $language1  ?>"/  />
           ...
           <input type="text" size="20"  name="language2" id="language2" value="<?php echo $language2  ?>"/  />
...
<b class="bt">翻译</b><br />
 ...
 <p> <label  for="word_t44">搜索（多重筛选）：</label> 
     <input type="text" size="20"  name="word_t44" id="word_t44" value="<?php if($word_t44!=""){echo $word_t44;}else{echo '搜索';}  ?>"/  />        
   </p>
  ...
  <p> <label  for="word_t1">查看详细：</label> 
    ...
    <p> <label  for="word_t26">播放视频：</label> 
     ...
     <p> <label  for="word_t26">关闭视频：</label> 
     <input type="text" size="20"  name="word_t27" id="word_t27" value="<?php if($word_t27!=""){echo $word_t27;}else{echo '关闭视频';}  ?>"/  />        
   </p> 
