 ...
 <div id="dcMain">
   <!-- 当前位置 -->
        ...
        <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
            <h3><a href="<?php echo url('Cats/addCategory'); ?>" class="actionBtn add">添加分类</a>作品分类</h3>
            <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
                  ...
                  <tr>
                        ...
                        <td align="center" class="td-catsort" catsort =<?php echo $vo['catsort']; ?> ><?php echo $vo['catsort']; ?></td>
                        <td align="center">
                        ...
                        <td align="center">
                            <a href="<?php echo url('Cats/addSubclassification',array('catid' => $vo['catid'])); ?>" class="btn-aa btn-primary-a">添加子类</a>
                            <a href="<?php echo url('Cats/editCategory',array('catid' => $vo['catid'])); ?>" class="btn-aa btn-warning-a">编辑</a>
                            <a href="javascript:;" catid="<?php echo $vo['catid']; ?>" class="btn-aa btn-danger-a">删除</a>
                        </td>
                  </tr>
                ...
                $('.btn-danger-a').on('click',function(){
                  var del =  confirm('确认要删除么？');
                    if (del) {
                        ...
                        $.post('<?php echo url("Cats/delCategory"); ?>',{catid : catid}, function(data){
                            if (data.status) {
                                layer.msg(data.msg, {icon: 1,time: 1500},function(){
                                    window.location.reload();
                                });
