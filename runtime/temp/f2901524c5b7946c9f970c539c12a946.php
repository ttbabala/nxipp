<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:55:"E:\www\web\nxipp.\template/admin\system\selArticle.html";i:1506305787;}*/ ?>
        ...
        <div id="list">
            <form name="action" id="formaction" method="post" action="#">
                <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
                 ...
                 <tr>
                      <td align="center"><input style="width: 20px;height: 20px;" type="radio" name="radio" class="idDisplay" value="<?php echo $vo['aid']; ?>" /></td>
                ...
                <div style="margin-top:10px;"><input name="submit" class="btn" type="submit" value="生成链接" /></div>
           </form>
        </div>
    </div>
 </div>
