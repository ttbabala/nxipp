   ...
   <!-- 当前位置 -->
        ...
        <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
            ...
            <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
                  ...
                  <tr>
                        ...
                        <td align="center">
                            <a href="<?php echo url('bak',['tp'=>'dowonload','name'=>$vo['name']]); ?>" class="btn-aa btn-primary-a" >下载</a>
                            <a onclick="handle('restore','<?php echo $vo['name']; ?>')" class="btn-aa btn-warning-a" >还原</a>
                            <a onclick="handle('del','<?php echo $vo['name']; ?>')" class="btn-aa btn-danger-a">删除</a>
                        </td>
                  </tr>
        ...
        <script type="text/javascript">
                function handle(tp,name=''){ 
                    if (tp){
                        $.post("<?php echo url('bak'); ?>",{tp:tp,name:name},function(response){
                            if (response){
