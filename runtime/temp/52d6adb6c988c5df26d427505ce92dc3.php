...
<div id="dcMain">
   <!-- 当前位置 -->
    ...
    <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
        <h3><a href="<?php echo url('Single/addSingle'); ?>" class="actionBtn add">添加单页</a>单页管理</h3>
        <div id="list">
                <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
                 ...
                 <tr>
                      ...
                      <td align="left"><?php echo $vo['single_status']; ?></td>
                      <td align="center">
                          <a href="<?php echo url('Single/editSingle',['id' => $vo['id']]); ?>" class="tab_a_link edit_btn">修改</a>
        ...
        <script type="text/javascript">
            $(function(){
                $('.btn-danger-a').on('click',function(){
                    ...
                    if (del) {
                        var id =$(this).attr('id');
                        $.post('<?php echo url("Single/delSingle"); ?>',{id : id}, function(data){
                           if (data.status) {
                                layer.msg(data.msg, {icon: 1,time: 1500},function(){
                                    window.location.reload();
                                });
